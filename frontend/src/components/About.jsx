    ...
    <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-primary-50 via-primary-100 to-primary-200 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="text-center p-6 md:p-8 rounded-2xl bg-surface shadow-soft-earth hover:shadow-earth-md transition-all duration-300 transform hover:-translate-y-2 border border-primary-200/50 backdrop-blur-sm">
            <div className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-primary-100 rounded-2xl mb-4 mx-auto">
            ...
            <div className="text-3xl md:text-4xl font-bold text-primary-900 mb-2">10,000+</div>
            <div className="text-primary-600 font-medium text-sm md:text-base">Active Readers</div>
          </div>
          ...
          <div className="text-center p-6 md:p-8 rounded-2xl bg-surface shadow-soft-earth hover:shadow-earth-md transition-all duration-300 transform hover:-translate-y-2 border border-primary-200/50 backdrop-blur-sm">
            ...
            <div className="text-3xl md:text-4xl font-bold text-primary-900 mb-2">50+</div>
            <div className="text-primary-600 font-medium text-sm md:text-base">Villages Served</div>
          </div>
          ...
          <div className="text-center p-6 md:p-8 rounded-2xl bg-surface shadow-soft-earth hover:shadow-earth-md transition-all duration-300 transform hover:-translate-y-2 border border-primary-200/50 backdrop-blur-sm">
            ...
            <div className="text-3xl md:text-4xl font-bold text-primary-900 mb-2">24/7</div>
            <div className="text-primary-600 font-medium text-sm md:text-base">News Updates</div>
          </div>
        </div>
