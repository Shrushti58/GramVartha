...
const CitizenDashboard = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      await fetch(`${import.meta.env.VITE_API_URL}/citizen/logout`, {
        method: "POST",
        credentials: "include",
      });
    } catch (error) {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [citizenResponse, wardNoticesResponse, allNoticesResponse] =
        await Promise.all([
          fetch(`${import.meta.env.VITE_API_URL}/citizen/profile`, {
            credentials: "include",
          }),
          fetch(`${import.meta.env.VITE_API_URL}/notice/citizen/notices`, {
            credentials: "include",
          }),
          fetch(`${import.meta.env.VITE_API_URL}/notice/fetch`),
        ]);
